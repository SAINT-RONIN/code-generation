...
class TransactionServiceTest {
    ...
    // Transfer debits the source, credits the destination, and validates all policies.
    @Test
    ...
    // Employee transfer debits source, credits destination, and validates employee rules.
    @Test
    ...
    // Employees cannot perform deposits.
    @Test
    ...
    // Employees cannot perform withdrawals.
    @Test
    ...
    // Deposit adds the amount to the account balance.
    @Test
    ...
    // Withdrawal subtracts the amount from the account balance.
    @Test
    ...
    // Both IBANs blank means the transaction type cannot be determined.
    @Test
    ...
    // ── Policy rejection — nothing saved when checks fail ────────────────────

    // No transaction is recorded when the caller doesn't own the source account.
    @Test
    ...
    // No transaction is recorded when the amount exceeds the absolute limit.
    @Test
    ...
    // No transaction is recorded when the employee policy rejects the transfer.
    @Test
    ...
    // Stubs all mocks needed for a successful transfer.
