...
public class AccountController {
    ...
    public ResponseEntity<List<AccountResponse>> getMyAccounts(
            // @AuthenticationPrincipal injects the currently logged-in user from the
            // SecurityContext
    ...
    public ResponseEntity<List<IbanSearchResponse>> searchByName(
        ...
        return ResponseEntity
                .ok(accountService.searchCustomerCheckingIbansByName(firstName, lastName, iban, caller.getId()));
    }
